...
public class ProductoVistaGrid extends JFrame {
    ...
    public ProductoVistaGrid(ListaCategorias listaCat, ListaInsumos listaIns) {
        this.listacategorias = listaCat;
        this.listainsumo = listaIns;

        setTitle("Administración de Productos (GridLayout)");
