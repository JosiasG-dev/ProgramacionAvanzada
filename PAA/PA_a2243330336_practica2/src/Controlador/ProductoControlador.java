...
public class ProductoControlador implements ActionListener, ListSelectionListener {
    ...
    public ProductoControlador(ProductoVista vista, ListaInsumos modeloInsumos, ListaCategorias modeloCategorias, Archivotxt archivoInsumos) {
        this.vista = vista;
        ...
        if (vista.getTextoBotonAgregar().equals("Agregar")) {
            ...
            if (datosCompletos()) {
                ...
                if (modeloInsumos.agregarInsumo(nuevo)) {
                    ...
                    vista.mostrarMensaje("El ID " + id + " ya existe. Tiene asignado: " + modeloInsumos.buscarInsumo(id));
                }
            } else {
    ...
    private boolean datosCompletos() {
        return !vista.getIdText().isEmpty() && !vista.getInsumoText().isEmpty() && vista.getCategoriaSeleccionada() != null;
    }
