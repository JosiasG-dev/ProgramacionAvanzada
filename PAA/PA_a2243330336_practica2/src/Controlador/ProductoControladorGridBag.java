...
public class ProductoControladorGridBag implements ActionListener, ListSelectionListener {

    private ProductoVistaGridBag vista;
    private ListaInsumos modeloInsumos;
    private ListaCategorias modeloCategorias;
    private Archivotxt archivoInsumos;

    public ProductoControladorGridBag(ProductoVistaGridBag vista, ListaInsumos modeloInsumos,
        ...
        vista.addAgregarListener(this);
        vista.addEliminarListener(this);
        vista.addSalirListener(this);
        vista.addTablaSelectionListener(this);
    }
    ...
    public void valueChanged(ListSelectionEvent e) {
        if (!e.getValueIsAdjusting()) {
            // Aquí se podría actualizar imagen si se desea
        }
    }
}
