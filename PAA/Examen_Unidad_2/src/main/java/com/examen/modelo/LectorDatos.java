...
public class LectorDatos {
    ...
    private DefaultTableModel modeloAsistencia = new DefaultTableModel();
    private DefaultTableModel modeloAtributos = new DefaultTableModel();
    ...
    private void cargarListasAsistencia(Sheet hoja) {
        ...
        for (Row fila : hoja) {
            ...
            if (primera) { 
                modeloAsistencia.setColumnIdentifiers(new String[]{"Grupo", "Profesor", "Materia", "Matricula", "Alumno"});
                primera = false; 
                continue; 
            }
            
            modeloAsistencia.addRow(new String[]{grupo, profesor, materia, matricula, alumno});
    ...
    private void cargarAtributos(Sheet hoja) {
        ...
        for (Row fila : hoja) {
            ...
            if (primera) {
                modeloAtributos.setColumnIdentifiers(new String[]{"Carrera", "Asignatura", "Atributo"});
                primera = false;
                continue;
            }

            modeloAtributos.addRow(new String[]{carrera, asignatura, atributo});
    ...
    public DefaultTableModel getModeloAsistencia() {
        return modeloAsistencia;
    }

    public DefaultTableModel getModeloAtributos() {
        return modeloAtributos;
    }
}
